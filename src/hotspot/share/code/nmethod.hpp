...
public:
  ...
  bool  make_not_entrant(ChangeReason change_reason, bool can_schedule_recompilation);
  bool  make_not_used() { return make_not_entrant(ChangeReason::not_used, false /* likely already recompiling */); }
